package com.putao.ptlog.viewer;
...
import com.putao.ptlog.R;
import com.putao.ptlog.widget.CustomDatePicker;
...
import static com.putao.ptlog.PTLog.ERROR;
import static com.putao.ptlog.PTLog.INFO;
...
public class PTLogActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void logLevelSelect(){
        ...
        String[] types = {"ALL", "DEBUG", "INFO", "ERROR"};
        b.setItems(types, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch(which){
                    case 0:
                        mSelectedLogLevel = 0; // ALL
                        break;
                    case 1:
                        mSelectedLogLevel = DEBUG;
                        break;
                    case 2:
                        mSelectedLogLevel = INFO;
                        break;
                    case 3:
                        mSelectedLogLevel = ERROR;
                        break;
                    default:
                        break;
                }
    ...
    private void queryLog(){
        Log.d(TAG, "Level:" + mSelectedLogLevel + " begin: "
                ...
                + mLimit);
        List<PTLogBean> logList = PTLog.queryLog(mSelectedLogLevel, mBeginDate, mEndDate, mLimit);
